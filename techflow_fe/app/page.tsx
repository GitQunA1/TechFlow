...
import { HardHat, PencilRuler, ShieldCheck, Workflow, Loader2, Globe, UserCog, Telescope } from "lucide-react";
...
import PlanningWorkspace from "@/components/techflow/planning-workspace";
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col font-sans">
            ...
            <div className="flex items-center gap-3">
              <div className="flex flex-col items-end">
                ...
                <Badge variant="outline" className="text-[10px] uppercase h-5 px-1.5 font-semibold">
                  ...
                  {user.role === "Planning" && <Telescope className="w-3 h-3 ml-1 inline" />}
                </Badge>
              </div>
              <Button 
                variant="outline" 
      ...
      <main className="flex-1">
        ...
        {user.role === "Planning" && <PlanningWorkspace />}
      </main>
